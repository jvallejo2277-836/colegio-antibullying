...
class ResolucionIncidenteSerializer(serializers.ModelSerializer):
    ...
    resuelto_por_nombre = serializers.CharField(
        source="resuelto_por.user.get_full_name", read_only=True
    )
...
class IncidentReportSerializer(serializers.ModelSerializer):
    ...
    colegio_nombre = serializers.CharField(source="colegio.nombre", read_only=True)
    tipo_incidente_detail = TipoIncidenteSerializer(
        source="tipo_incidente", read_only=True
    )
    estudiantes_involucrados_detail = PerfilUsuarioSerializer(
        source="estudiantes_involucrados", many=True, read_only=True
    )
    reportero_nombre_completo = serializers.CharField(
        source="reportero.user.get_full_name", read_only=True
    )
    estado_display = serializers.CharField(source="get_estado_display", read_only=True)
    urgencia_display = serializers.CharField(
        source="get_urgencia_display", read_only=True
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            "colegio_nombre",
            "tipo_incidente",
            "tipo_incidente_detail",
            "titulo",
            "descripcion",
            "fecha_incidente",
            "lugar_incidente",
            "estudiantes_involucrados",
            "estudiantes_involucrados_detail",
            "reportero",
            "reportero_nombre_completo",
            "anonimo",
...
class IncidentReportListSerializer(serializers.ModelSerializer):
    colegio_nombre = serializers.CharField(source="colegio.nombre", read_only=True)
    tipo_incidente_nombre = serializers.CharField(
        source="tipo_incidente.nombre", read_only=True
    )
    estado_display = serializers.CharField(source="get_estado_display", read_only=True)
    urgencia_display = serializers.CharField(
        source="get_urgencia_display", read_only=True
