...
from core.models import Colegio, CustomUser
...
def crear_usuarios_prueba():
    ...
    for user_data in usuarios_prueba:
        ...
        print(
            f"✅ Usuario creado: {user.get_full_name()} ({user.get_role_display()}) - {colegio_nombre}"
        )
    ...
    if usuarios_creados:
        ...
        for user in usuarios_creados:
            print(
                f"👤 {user.get_role_display()}: {user.username} / contraseña: {user_data['password']}"
            )
